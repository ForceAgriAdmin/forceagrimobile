...
class _AddWorkerPageState extends ConsumerState<AddWorkerPage> {
          ...
          child: ListView(
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: types
                    .map((type) => DropdownMenuItem(value: type.id, child: Text(type.description)))
                    .toList(),
  ...
  Future<void> _submit(String farmId) async {
    if (!_formKey.currentState!.validate() || _image == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Complete all fields and upload a photo.')));
      return;
    }
